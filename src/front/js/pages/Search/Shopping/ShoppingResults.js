        ...
        <div className="search-results">
            ...
            <div className='search-result'>
                ...
                <div className="business-info">
                    <h2 className='subtitle'>Hudson Yards</h2>
                    <BusinessRating/>
                    <p>$$ <span class='tag'>Shopping</span> <span class='tag'></span></p>
                </div>
            ...
            <div className='search-result'>
                <img src='https://via.placeholder.com/210' alt="business" className='business-image'></img>
                <div className="business-info">
                    <h2 className='subtitle'>75 Rockefeller Plaza</h2>
                    <BusinessRating/>
                    <p>$$ <span class='tag'>Shopping</span> <span class='tag'></span></p>
                </div>
                <div className='contact-info'>
